    ...
    <>
      ...
      >
        ...
        <div id="list">
          <ul>
            <li>
              <Link to="/" style={{ color: fillColor }}>
                MAIN
              </Link>
            </li>
            <li>
              <Link to="/gallery" style={{ color: fillColor }}>
                GALLERY
              </Link>
            </li>
            <li>
              <Link to="/projects" style={{ color: fillColor }}>
                PROJECTS
              </Link>
            </li>
            <li>
              <Link to="/certifications" style={{ color: fillColor }}>
                CERTIFICATIONS
              </Link>
            </li>
            <li>
              <Link to="/contacts" style={{ color: fillColor }}>
                CONTACTS
              </Link>
            </li>
          </ul>
